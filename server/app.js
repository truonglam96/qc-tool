...
*/  
    ...
    const s = server.listen(SERVER_PORT, (client) => {
        console.log(`Server is running on url:  http://localhost:${s.address().port}`);
        console.log(`Test Automatic on url: http://localhost:${s.address().port}/automatic-test`);
        console.log(`Test Manual on url: http://localhost:${s.address().port}/manual-test`);
    });
